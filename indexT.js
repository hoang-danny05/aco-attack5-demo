...
app.get("/", (req, res) => {
  ...
  <script>
    function posttext() {
      ...
      const current = document.getElementById("output").innerText;
      console.log(current);

      document.getElementById("output").innerText = current + "<br />Post: " + filter(text.value);
    }
    ...
    function postimage() {
      ...
      document.getElementById("output").innerText = current + "<br /> <img height=\'200\' src=" + filter(src.value) + ">";
    }
  </script>
  `
